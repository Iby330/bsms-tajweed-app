...
image = (
    ...
    .pip_install(
        ...
        "twilio",  # For SMS (booking-sms webhook)
    )
    .add_local_dir("/Users/ibrahimramadan/Ai Automation/directives", remote_path="/app/directives")
    .add_local_dir("/Users/ibrahimramadan/Ai Automation/execution", remote_path="/app/execution")
    .add_local_file("/Users/ibrahimramadan/Ai Automation/execution/webhooks.json", remote_path="/app/webhooks.json")
    .add_local_file("/Users/ibrahimramadan/Ai Automation/.tmp/demo_kickoff_call_transcript.md", remote_path="/app/demo_kickoff_call_transcript.md")
    .add_local_file("/Users/ibrahimramadan/Ai Automation/.tmp/demo_sales_call_transcript.md", remote_path="/app/demo_sales_call_transcript.md")
)
