    ...
    rules: [
      {
        ...
        name: "Madd Muttasil",
        arabic: "مد متصل",
        gloss: "The madd letter and the hamzah are in one word, so stretch it four counts.",
        from: 0,
        to: 0,
        counts: "4 counts",
      },
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the ya of ٱلَّذِينَ: two counts, no more.",
        from: 1,
        to: 1,
        counts: "2 counts",
      },
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif of لَا: two counts, no more.",
        from: 3,
        to: 3,
        counts: "2 counts",
      },
...

  {
    ...
    rules: [
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif of مَا: two counts, no more.",
        from: 6,
        to: 6,
        counts: "2 counts",
      },
      {
        ...
        name: "Ghunnah",
        arabic: "غنة",
        gloss: "A nun with shadda is always held with ghunnah, two counts.",
        from: 9,
        to: 9,
        counts: "2 counts",
      },
...

  {
    ...
    rules: [
      ...
      },
      {
        ...
        name: "Idhar Shafawi",
        arabic: "إظهار شفوي",
        gloss: "Meem sakinah before ha. Show it clearly, with no ghunnah and no merging.",
        from: 4,
        to: 5,
      },
      {
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif of ذَوَا: two counts, no more.",
        from: 2,
        to: 2,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the small alif of بَـٰلِغَ: two counts, no more.",
        from: 6,
        to: 6,
        counts: "2 counts",
      },
...

  {
    ...
    rules: [
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the small alif of كَفَّـٰرَةٌ: two counts, no more.",
        from: 1,
        to: 1,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif of طَعَامُ: two counts, no more.",
        from: 2,
        to: 2,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the small alif and the ya of مَسَـٰكِينَ: two counts, no more.",
        from: 3,
        to: 3,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the small alif of ذَٰلِكَ: two counts, no more.",
        from: 6,
        to: 6,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif after the ya of صِيَامًا: two counts, no more.",
        from: 7,
        to: 7,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the waw of لِّيَذُوقَ: two counts, no more.",
        from: 8,
        to: 8,
        counts: "2 counts",
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif of وَبَالَ: two counts, no more.",
        from: 9,
        to: 9,
        counts: "2 counts",
      },
...

  {
    ...
    rules: [
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the alif of عَادَ: two counts, no more.",
        from: 1,
        to: 1,
        counts: "2 counts",
      },
...

  {
    ...
    rules: [
      ...
      },
      {
        ...
        name: "Madd Asli",
        arabic: "مد أصلي",
        gloss: "The natural madd on the ya of عَزِيزٌ: two counts, no more.",
        from: 1,
        to: 1,
        counts: "2 counts",
      },
