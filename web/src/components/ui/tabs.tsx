...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        // cursor-pointer: Tailwind v4's preflight sets `cursor: default` on
        // <button>, so tabs came up with the arrow while the sidebar links —
        // real anchors — got the hand. Same control, two cursors.
